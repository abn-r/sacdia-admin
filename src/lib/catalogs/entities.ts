...
export const entityConfigs: Record<EntityKey, EntityConfig> = {
  ...
  medicines: {
    key: "medicines",
    title: "Medicamentos",
    singularTitle: "Medicamento",
    description: "Catálogo de medicamentos para perfil de salud.",
    routeBase: "/dashboard/catalogs/medicines",
    listEndpoint: "/admin/medicines",
    adminEndpoint: "/admin/medicines",
    idField: "medicine_id",
    nameField: "name",
    fields: [
      { name: "name", label: "Nombre", type: "text", required: true },
