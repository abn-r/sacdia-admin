...
const SECTION_META_BY_KIND: Record<SectionKind, SectionMetaEntry> = {
  adventurers: {
    ...
    range: "6–9 años",
    tone: "rose",
    swatch: "bg-section-aventureros/15 text-section-aventureros",
    pill: "bg-section-aventureros/10 text-section-aventureros border-section-aventureros/20",
    iconBg: "bg-section-aventureros text-white",
    barBg: "bg-[#70C1DC]",
    donutHex: "#70C1DC",
  },
  pathfinders: {
