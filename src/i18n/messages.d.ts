  ...
  clubs: {
    ...
    pages: {
      ...
      detail: {
        ...
        stats: {
          membersLabel: string;
          membersOccupancy: string;
          membersNoTarget: string;
          sectionsLabel: string;
          sectionsAll: string;
          sectionsInactive: string;
          sectionBarActive: string;
          sectionBarInactive: string;
          unitsLabel: string;
          unitsEmpty: string;
          unitsAvg: string;
          requestsLabel: string;
          requestsNoData: string;
        ...
        infoPanel: {
          ...
          districtUndefined: string;
          churchUndefined: string;
          blockAddress: string;
          addressEmpty: string;
          blockCapacity: string;
          capacityOccupancy: string;
          capacityNoTarget: string;
          mapsLink: string;
        };
        overview: {
          ...
          healthNoPending: string;
          healthPending: string;
          healthActiveSections: string;
          healthScorePending: string;
          healthDescription: string;
          rankingTitle: string;
          rankingSubtitle: string;
          rankingUnitsCount: string;
        ...
        sidebar: {
          actionsTitle: string;
          actionEdit: string;
          actionCreateUnit: string;
          actionApproveRequests: string;
          actionReviewRequests: string;
          actionConfigureSections: string;
          actionInvestiture: string;
          actionDelete: string;
          eventsTitle: string;
          eventsEmpty: string;
