...
import { StudioAppSidebar } from "@/components/studio-shell/app-sidebar";
import { StudioAppHeader } from "@/components/studio-shell/app-header";
...
import { V2PanelPathProvider } from "@/lib/v2/panel-path-context";
...
export default async function DashboardV2Layout({
  ...
  const clientMessages = pickMessages(
    messages,
    getClientMessageNamespacesForDashboardPath("/v2/dashboard", messages),
  );
      ...
      <AuthProvider initialUser={initialUser}>
        <QueryProvider>
          ...
          >
            ...
            <StudioAppSidebar variant={variant} collapsible={collapsible} />
            <SidebarInset
              className={cn(
