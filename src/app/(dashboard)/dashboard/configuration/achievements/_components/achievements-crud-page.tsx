...
function pickBadgeUrl(item: AchievementRecord): string | null {
  return toText(item.badge_image_url);
}
  ...
  return (
    <div className="space-y-6">
        ...
        <BreadcrumbList>
          <BreadcrumbItem>
            <BreadcrumbLink asChild>
              <Link href="/dashboard/configuration/achievements">{t("breadcrumbRoot")}</Link>
            </BreadcrumbLink>
          </BreadcrumbItem>
          <BreadcrumbSeparator />
          <BreadcrumbItem>
      ...
      <PageHeader
        ...
        actions={
          <Button asChild>
            <Link href={`/dashboard/configuration/achievements/${categoryId}/new`}>
          ...
          <>
            <div className="overflow-x-auto rounded-md border">
              <Table>
                <TableHeader>
                  <TableRow>
                    <TableHead>{t("tableColBadge")}</TableHead>
                ...
                <TableBody>
                  {achievements.map((item, idx) => {
                    ...
                    const badgeUrl = pickBadgeUrl(item);
                    const rowKey = achId
                      ? `achievement-${achId}`
                    ...
                    return (
                      ...
                      >
                        <TableCell>
                          <div
                            className="relative size-10 overflow-hidden rounded-full border bg-muted"
                            style={
                              tier
                                ? { boxShadow: `0 0 0 2px ${TIER_COLORS[tier]}60` }
                                : undefined
                            }
                          >
                            {badgeUrl ? (
                        ...
                        <TableCell className="sticky right-0 z-10 border-l bg-background">
                          <div className="hidden gap-1 md:flex">
                            {achId ? (
                              ...
                              >
                                <Link
                                  href={`/dashboard/configuration/achievements/${categoryId}/${achId}/edit`}
                                  prefetch={false}
                                >
